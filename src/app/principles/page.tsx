                ...
                <div className="container ethics-content">
                    <div className="row">
                        <div className="col-12">
                            ...
                            <p className="ethics-paragraph">در کارگزاری فدک، پایبندی به اصول اخلاقی و رفتار حرفه‌ای،
                                سنگ‌بنای اعتماد در بازار سرمایه است. این اصول با الهام از استانداردهای بین‌المللی مؤسسه
                                CFA و با در نظر گرفتن ویژگی‌های بازار سرمایه ایران تدوین و به مرور زمان بازنگری
                                شده‌اند.</p>
                            <p className="ethics-paragraph">رعایت اخلاق حرفه‌ای توسط فعالان بازار، نه تنها منافع
                                سرمایه‌گذاران را حفظ می‌کند، بلکه موجب رشد اعتماد عمومی و توسعه پایدار بازارهای مالی
                                می‌شود.</p>
                            <p className="ethics-paragraph">اعتماد، سرمایه‌ای گران‌بهاست که به‌سختی به دست می‌آید و
                                به‌راحتی از بین می‌رود. از این رو، شرکت‌ها و کارکنان باید با پایبندی به بالاترین
                                استانداردهای اخلاقی، در حفظ این اعتماد بکوشند.</p>
                            <p className="ethics-paragraph">ما در فدک باور داریم که فرهنگ اخلاق‌مدار باید از درون سازمان
                                آغاز شود. مدیران و کارکنان در همه سطوح، از تحلیل‌گران و معامله‌گران گرفته تا نیروهای
                                پشتیبانی، موظف به رعایت این اصول هستند تا منافع مشتریان و کارفرمایان در بالاترین سطح حفظ
                                شود.</p>
                        </div>
