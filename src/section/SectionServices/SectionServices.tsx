                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6 text-center order-1">
                            <img
                                src="/assets/images/slider/credit_600x400.webp"
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-md-8">
                            ...
                            {/*    اولین و مهمترین گام جهت فعالیت در بورس انرژی دریافت »کد معاملاتی« است. متقاضیان باید از طریق کارگزاری فدک*/}
                            {/*    و با تحویل مدارک و فرمهای مشخص شده، اقدام به دریافت کد معاملاتی کنند.*/}
                            {/*</p>*/}
                        </div>
